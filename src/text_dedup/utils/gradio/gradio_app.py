...
class ClusterVisualizer:
    def __init__(self) -> None:
        ...
        self.cluster2ids: Optional[dict] = None
    ...
    def plot_cluster_distribution(self, cluster_size_slider: tuple[int, int]) -> Optional[go.Figure]:
    ...
    def plot_detailed_distribution(self, bin_size: int = 10) -> Optional[go.Figure]:
    ...
    def plot_cluster_treemap(self, max_clusters: int = 100) -> Optional[go.Figure]:
    ...
    def get_top_clusters(self, n: int = 20) -> Optional[pd.DataFrame]:
    ...
    def explore_cluster(self, cluster_id: int, max_samples: int = 10) -> tuple[Optional[pd.DataFrame], str]:
